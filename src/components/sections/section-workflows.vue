<template>
  <section class="container mx-auto mt-10 mb-14 lg:mb-36">
    <div class="block lg:flex">
      <div class="p-5 mb-14 lg:mb-0 w-full lg:w-1/3 bg-primary text-center">
      ...
      <div class="w-full lg:w-2/3 flex flex-col px-5 lg:px-10 pb-20">
        <div>
          ...
          <div class="text-lg lg:text-xl mt-3">
            Pertemuan awal untuk konsultasi mengenai kebutuhan Anda.
          </div>
        </div>
        <div class="mt-12">
          <div class="flex items-center">
